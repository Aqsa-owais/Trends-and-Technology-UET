...
import { Code, Users, Award, ArrowRight, BookOpen, Laptop, Trophy, Target, Menu, X } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/session" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200">
                About Session
              </Link>
              <Link to="/resources" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200">
                Resources
              </Link>
              <Link to="/assignments" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200">
                Assignments
              </Link>
              <Link
                to="/register"
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Learn programming from basics to advanced level with our comprehensive courses. 
                  Join thousands of students who have transformed their careers through coding.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl p-8 shadow-2xl transform rotate-3 hover:rotate-1 transition-transform duration-300">
                <div className="bg-white rounded-xl p-6 space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Interactive Coding</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              iCodeGuru is a comprehensive programming learning platform designed to help students 
              master coding skills from beginner to advanced levels. We provide structured courses, 
              hands-on projects, and personalized mentorship to ensure your success in the tech industry.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-gray-50 p-6 rounded-2xl hover:bg-blue-50 transition-colors duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Follow our carefully designed curriculum from basics to advanced concepts
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6">
                <h3 className="text-xl font-bold text-white">Python Programming</h3>
                <p className="text-blue-100 mt-2">From basics to advanced concepts</p>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="bg-gradient-to-r from-yellow-500 to-orange-500 p-6">
                <h3 className="text-xl font-bold text-white">JavaScript & React</h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="bg-gradient-to-r from-red-500 to-pink-500 p-6">
                <h3 className="text-xl font-bold text-white">Java Programming</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-gray-50 p-8 rounded-2xl hover:bg-blue-50 transition-colors duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Learn from industry experts with years of real-world programming experience. 
                Our instructors bring practical knowledge to every lesson.
              </p>
            </div>
            ...
            <div className="group bg-gray-50 p-8 rounded-2xl hover:bg-purple-50 transition-colors duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Hands-On Practice</h3>
              <p className="text-gray-600 leading-relaxed">
                Build real projects and applications while learning. Practice coding with 
            ...
            <div className="group bg-gray-50 p-8 rounded-2xl hover:bg-emerald-50 transition-colors duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Join our active community of learners. Get help, share knowledge, and 
            ...
            <div className="group bg-gray-50 p-8 rounded-2xl hover:bg-indigo-50 transition-colors duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Career Focused</h3>
              <p className="text-gray-600 leading-relaxed">
                Our curriculum is designed with industry needs in mind. Learn skills 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Foundation</h3>
              <p className="text-gray-300 leading-relaxed">
                Start with programming fundamentals, syntax, and basic problem-solving skills. 
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-300 leading-relaxed">
                Apply your knowledge through hands-on projects and coding challenges. 
                Build real applications and strengthen your skills.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-300 leading-relaxed">
                Advanced topics, system design, and professional development practices. 
                Become job-ready with industry-standard skills.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join iCodeGuru today and transform your career with our comprehensive programming courses. 
            Start learning from industry experts and build the skills employers want.
          </p>
          <Link
            to="/register"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Empowering students to master programming and build successful careers in technology.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-center md:text-left">
              © 2025 iCodeGuru. Transforming lives through programming education.
            </p>
